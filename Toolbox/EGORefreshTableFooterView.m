...
//  Demo
//
//дї®ж”№дєєпјљз¦љжќҐејє iphoneејЂеЏ‘qqзѕ¤пјљ79190809 й‚®з®±пјљzhuolaiqiang@gmail.com
//
...
- (void)refreshLastUpdatedDate {
	...
	if ([_delegate respondsToSelector:@selector(egoRefreshTableFooterDataSourceLastUpdated:)]) {
		...
		[formatter setAMSymbol:@"дёЉеЌ€"];
		[formatter setPMSymbol:@"дё‹еЌ€"];
		[formatter setDateFormat:@"yyyy/MM/dd hh:mm:a"];
		_lastUpdatedLabel.text = [NSString stringWithFormat:@"жњЂеђЋж›ґж–°: %@", [formatter stringFromDate:date]];
...
- (void)setState:(EGOPullRefreshState)aState{
    ...
    {
			_statusLabel.text = NSLocalizedString(@"жќѕејЂеЌіеЏЇж›ґж–°...", @"жќѕејЂеЌіеЏЇж›ґж–°...");
			[CATransaction begin];
		...
		case EGOOPullRefreshNormal:
    {
			...
			_statusLabel.text = NSLocalizedString(@"дёЉж‹‰еЌіеЏЇж›ґж–°...", @"дёЉж‹‰еЌіеЏЇж›ґж–°...");
    ...
    {
			_statusLabel.text = NSLocalizedString(@"еЉ иЅЅдё­...", @"еЉ иЅЅдё­...");
...
//ж‰‹жЊ‡е±Џе№•дёЉдёЌж–­ж‹–еЉЁи°ѓз”Ёж­¤ж–№жі•
...
//еЅ“з”Ёж€·еЃњж­ўж‹–еЉЁпјЊе№¶дё”ж‰‹жЊ‡д»Ће±Џе№•дё­ж‹їејЂзљ„зљ„ж—¶еЂ™и°ѓз”Ёж­¤ж–№жі•
...
//еЅ“ејЂеЏ‘иЂ…йЎµйќўйЎµйќўе€·ж–°е®ЊжЇ•и°ѓз”Ёж­¤ж–№жі•пјЊ[delegate egoRefreshScrollViewDataSourceDidFinishedLoading: scrollView];
