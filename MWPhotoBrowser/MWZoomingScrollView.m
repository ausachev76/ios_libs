...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    ...
    _photoImageView.contentMode = UIViewContentModeScaleAspectFit; //UIViewContentModeCenter;
...
- (void)displayImage {
	if (_photo && _photoImageView.image == nil) {
		...
		if (img) {
			...
			_photoImageView.frame = self.bounds; //photoImageViewFrame; // fit image to screen
