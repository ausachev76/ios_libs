...
- (BOOL)isLight
{
  ...
  if ( numComponents >= 3 )
    return (0.299 * colors[0] + 0.587 * colors[1] + 0.114 * colors[2]) >= 0.5f;
  else if ( numComponents >= 1 )
    return colors[0] >= 0.5f;
  return NO;
}
...
- (NSString *)stringFromColor
{
  ...
  return [NSString stringWithFormat:@"#%02X%02X%02X",
          MIN(255, (int)(256 * components[MIN(0,totalComponents-2)])),
          MIN(255, (int)(256 * components[MIN(1,totalComponents-2)])),
          MIN(255, (int)(256 * components[MIN(2,totalComponents-2)]))];
}

- (NSString *)stringFromColorWithAlpha
{
  const size_t totalComponents = CGColorGetNumberOfComponents(self.CGColor);
  const CGFloat * components = CGColorGetComponents(self.CGColor);
  return [NSString stringWithFormat:@"#%02X%02X%02X%02X",
          ...
          MIN(255, (int)(256 * components[MIN(1,totalComponents-2)])),
          MIN(255, (int)(256 * components[MIN(2,totalComponents-2)])),
          MIN(255, (int)(256 * components[MIN(3,totalComponents-2)]))]; // alpha: max 1 => FF
}
