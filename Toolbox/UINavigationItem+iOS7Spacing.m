...
{
  if ([self isIOS7] && leftBarButtonItem && leftBarButtonItem.customView )
  {
...
- (void)mk_setLeftBarButtonItems:(NSArray *)leftBarButtonItems
{
  if ([self isIOS7] && leftBarButtonItems && leftBarButtonItems.count > 0){
    ...
    NSMutableArray *items = [[[NSMutableArray alloc] initWithCapacity:leftBarButtonItems.count + 1] autorelease];
...
{
  if ([self isIOS7] && rightBarButtonItem && rightBarButtonItem.customView )
  {
...
- (void)mk_setRightBarButtonItems:(NSArray *)rightBarButtonItems
{
  if ([self isIOS7] && rightBarButtonItems && rightBarButtonItems.count > 0) {
    ...
    NSMutableArray *items = [[[NSMutableArray alloc] initWithCapacity:rightBarButtonItems.count + 1] autorelease];
    [items addObject:[self spacer]];
