...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options  andResize:(CGSize)size withContentMode:(UIViewContentMode)mode success:(SDWebImageSuccessBlock)success failure:(SDWebImageFailureBlock)failure;
