...
@synthesize delegate, subtitle, rightAccessoryView, subtitleView, leftAccessoryView, titleView, title, calloutOffset, smbackground;
...
- (SMCalloutViewBackground *)background
{
    ...
    return self.smbackground ? : ( self.smbackground = [SMCalloutViewBackground systemBackground] );
}
...
- (CGFloat)centeredPositionOfView:(UIView *)view
                    ifSmallerThan:(CGFloat)height
{
...
-(void)dealloc
{
  self.leftCapImage      = nil;
  self.rightCapImage     = nil;
  self.topAnchorImage    = nil;
  self.bottomAnchorImage = nil;
...
{
  SMCalloutViewBackground *background = [[SMCalloutViewBackground alloc] init];
